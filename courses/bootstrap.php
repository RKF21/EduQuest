...
<body>
    ...
    <div class="content">
        <h1 class="text-center">Bootstrap Course</h1>
        
        <br><br>
        <h2 id="overview">Course Overview</h2>
        <p>This section provides an overview of Bootstrap, the popular front-end framework for building responsive web pages.</p>
          ...
          &lt;!-- Example Bootstrap code --&gt;
           &lt;div class="container"&gt;
            &lt;div class="row"&gt;
             &lt;div class="col-md-12"&gt;
               &lt;h1&gt;Hello, World!&lt;/h1&gt;
               &lt;p&gt;This is an example of Bootstrap code.&lt;/p&gt;
             &lt;/div&gt;
            &lt;/div&gt;
          &lt;/div&gt;
        </code></pre>
