...
<body>
    ...
    <div class="content">
        <h1 class="text-center">JavaScript Course</h1>
         <br><br>
        <h2 id="overview">Course Overview</h2>
        <p>This section provides an overview of JavaScript, the programming language used to create dynamic web content.</p>
